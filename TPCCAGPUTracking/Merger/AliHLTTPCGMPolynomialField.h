...
public:
  ...
  static void GetPolynomsTrd( float x, float y, float z, float f[fkTrdM] );
...
inline void AliHLTTPCGMPolynomialField::GetPolynomsTrd( float x, float y, float z, float f[fkTrdM] )
{
...
GPUd() inline void AliHLTTPCGMPolynomialField::GetFieldTrd( float x, float y, float z, float B[3] ) const
{
  float f[fkTrdM];
...
GPUd() inline float AliHLTTPCGMPolynomialField::GetFieldTrdBz( float x, float y, float z ) const
{
  float f[fkTrdM];
  GetPolynomsTrd(x,y,z,f);
  float bz = 0.f;
